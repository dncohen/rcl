...
// Maniputate Ripple Consensus Ledger keypairs.
// An upspin-inspired command with subcommands.
...
instance
  ...
  rcl-key generate -help

explains the purpose and usage of the 'generate' subcommand.

There is a set of global flags such as -config to specify the
configuration directory, where rcl-key expects to find one or more
